...
//        when(tariffIntervalRepository.findByTariffId(anyLong()))
...
//        verify(tariffIntervalRepository).findByTariffId(tariff.getId());
//    }
//
//    @Test
...
//    }
//
//    private TariffInterval createTariffInterval(int id, int interval, BigDecimal price) {
